...
@section('content')
        ...
        {!! Form::open(['url' => '/admin/housingtemplate', 'method' => 'POST','enctype'=>'multipart/form-data']) !!}

            <input type="hidden" name="id" value="{{$template->id}}">
        <div class="form-group">
            {!! Form::label('Name', 'Name') !!}
            {!! Form::text('name','HousingTemplate'.$template->id,['class'=>'form-control', 'disabled'=>'disabled']) !!}
        </div>
        <div class="form-group">
