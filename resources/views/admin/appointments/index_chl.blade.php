    ...
    <form action="{{ route('chl.appointments.generate') }}" method="post" id="appointment-form">
        ...
        <table id="appointment-table" class="tablesorter" style="width: 100%">
            ...
            <tr>
                ...
                <th style="width: 5%;">
                    <a href="{{ route('chl.appointments.all') }}?page=1&sort=job_id&direction={{ request()->get('sort') == 'job_id' && request()->get('direction') == 'asc' ? 'desc' : 'asc' }}">
                        Job ID
                ...
                <th>
                    <a href="{{ route('chl.appointments.all') }}?page=1&sort=given_name&direction={{ request()->get('sort') == 'given_name' && request()->get('direction') == 'asc' ? 'desc' : 'asc' }}">
                        Contact Name
                ...
                <th>
                    <a href="{{ route('chl.appointments.all') }}?page=1&sort=address&direction={{ request()->get('sort') == 'address' && request()->get('direction') == 'asc' ? 'desc' : 'asc' }}">
                        Address
                ...
                <th>
                    <a href="{{ route('chl.appointments.all') }}?page=1&sort=city&direction={{ request()->get('sort') == 'city' && request()->get('direction') == 'asc' ? 'desc' : 'asc' }}">
                        City
                ...
                <th style="width: 7%;">
                    <a href="{{ route('chl.appointments.all') }}?page=1&sort=postcode&direction={{ request()->get('sort') == 'postcode' && request()->get('direction') == 'asc' ? 'desc' : 'asc' }}">
                        Postcode
                ...
                <th style="width: 10%;">
                    <a href="{{ route('chl.appointments.all') }}?page=1&sort=send_date&direction={{ request()->get('sort') == 'send_date' && request()->get('direction') == 'asc' ? 'desc' : 'asc' }}">
                        Schedule Date
                ...
                <th>
                    <a href="{{ route('chl.appointments.all') }}?page=1&sort=work_type&direction={{ request()->get('sort') == 'work_type' && request()->get('direction') == 'asc' ? 'desc' : 'asc' }}">
                        Work type
