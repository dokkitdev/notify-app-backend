...
(function (global$1) {
  ...
  var equiv = (function () {
  	...
  	function typeEquiv(a, b) {
  		...
  		// pages order. The pairs queue is also used to avoid reprocessing any pair of
  	...
  	function innerEquiv(a, b) {
  		...
  		for (i = 0; i < pairs.length; i++) {
  			...
  			// breadth-first pages order. It also avoids the reprocessing of
  ...
  */
  ...
  (function () {
  	...
  	function toolbarModuleFilter() {
  		...
  		moduleSearch.id = "qunit-modulefilter-pages";
  		...
  		label.id = "qunit-modulefilter-pages-container";
  		...
  		// Processes module pages box input
